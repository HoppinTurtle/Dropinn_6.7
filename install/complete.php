                      ...
                      <div id="main">
                        ...
                        <div class="block_tab">
											...
											<br />
											 ...
											 <p>Good Luck!</p>
 <p>Note: You have to upload the css,js,images to the Cloudinary account</p>
<p> To auto upload your source use this URL <?php echo "http://yoursite.com/cron/cloudinary_cron"; ?>' and wait till the upload completes.</p>
                                              </div>
