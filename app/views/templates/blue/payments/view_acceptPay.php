...
<div id="book_it" class="container_bg container"> 
  ...
  <div id="payment_options" class="Box bookit_Box">
    ...
    <div class="payment_tabs">
 	 		...
 	 		<input type="hidden" value="<?php echo $amt; ?>" name="commission_amount" />
      ...
      <div id="payment_method_paypal" class="payment_method_content<?php echo $showP; ?>" title="">
	   ...
	   <div class="currency_alert"><?php echo translate("This payment transacts in"); ?> <?php echo get_currency_symbol1().get_currency_code(); ?>. <?php echo translate("Your total charge is"); ?> <?php echo get_currency_symbol1().$amt; ?>.</div>
		
		<?php $this->session->set_userdata('accept_pay',get_currency_value($amt)); ?>
		<div class="paypal_explanation col-md-2 col-sm-5 col-xs-5 "></div>
        <p class="payment_method_explanation "> <span style="font-weight:bold;"><?php echo translate("Instructions"); ?>:</span> <br>
    ...
    <div id="payment_method_2c" class="payment_method_content<?php echo $show2C; ?>">
        ...
        <p class="payment_method_explanation col-md-10 col-sm-7 col-xs-7"> <span style="font-weight:bold;"><?php echo translate("Instructions:"); ?></span> <br>
          <?php echo translate("After clicking 'Book it' you will be redirected to Braintree to complete payment."); ?> <span style="font-weight:bold;"> <?php echo translate("You must complete the process or the transaction will not occur."); ?> </span> </p>
        <div class="clear"></div>
    </div>
    <div id="payment_method_stripe" class="payment_method_content<?php  if (isset($showst)) {echo $showst;}; ?>">
	  ...
	  {
	  	?>
	    <div class="currency_alert"><?php echo translate("This payment transacts in"); ?> <?php echo get_currency_symbol1($id).get_currency_code(); ?>. <?php echo translate("Your total charge is"); ?> <?php echo get_currency_symbol1($id).' '.$final_amt; ?>.</div>
		<?php }
	   else
	   	{ ?>
	   	<div class="currency_alert"><?php echo translate("This payment transacts in"); ?> <?php echo get_currency_symbol1($id).get_currency_code(); ?>. <?php echo translate("Your total charge is"); ?> <?php echo get_currency_symbol1($id).$amt; ?>.</div>
	   	<?php
	   	} ?>
	   			
        <p class="payment_method_explanation stripe_explanation"> <span style="font-weight:bold;"><?php echo translate("Instructions:"); ?></span> <br>
    ...
    <p>
				<input type="button" name="book_it_button" id="p4_book_it_button" class="btn_dash large blue" value="<?php echo translate("Accept reservation request"); ?>"  />
    </p>
...
jQuery('.stripe_explanation').css('background-image',"url(<?php echo base_url();?>images/strip-back.png)");
      ...
      //  $('p4_book_it_button').disabled = 'disabled';
        ...
        payment_options_tabber_obj = tabberAutomatic();
						  ...
						  addTab('Paypal', 'payment_method_paypal', 'paypal');
								...
								<?php }if($result[2]->is_enabled == 1) {?>
							    addTab('Stripe', 'payment_method_stripe', 'stripe');
								<?php } ?>
