    ...
    <div class="neighborhoods_section">
    	<div class="container">
        	<div class="main_neighborhood">
                <div class="neighborhoods_span8 col-md-8 col-sm-7 col-xs-12">
                	<?php
  	if(isset($places))
	{
		?>
     ...
     <meta property="og:title" content="<?php echo translate('Love the').' '.$place.' '.translate('neighbourhood page on').' '.$this->dx_auth->get_site_title(); ?>" />
      ...
      <div class="neighborhoods_span4 sidebar col-md-4 col-xs-12 col-sm-3">
    ...
    <div class="container">
        ...
        <h2 class="neighborhoods_section neg_sect" style="margin-top:5%;"><?php echo $row->image_title; ?></h2>
                    ...
                    <div class="col-md-12 col-xs-12 col-sm-12">
                          <img style="margin-bottom: 5px;" class="feature col-md-12 col-xs-12 col-sm-12 padd-zero" height="467" alt="one R1" src="<?php echo cdn_url_images().'/images/neighbourhoods/'.$image_s->city_id.'/'.$image_s->id.'/'.$row->big_image1; ?>"  />
                    </div>
             
                <div class="center caption col-md-12 col-sm-12 col-xs-12">
                    <div class="primary">
    	...
    	<section style="padding: 0;">
                    ...
                    <div class="col-md-6 col-xs-12 col-sm-6">
                          <img class="feature col-md-12 col-sm-12 col-xs-12 padd-zero img-size mar-size"  height="304" alt="one R1" src="<?php echo cdn_url_images().'/images/neighbourhoods/'.$image_s->city_id.'/'.$image_s->id.'/'.$row->small_image1; ?>"  />
                        </div>
                        <div class="col-md-6 col-xs-12 col-sm-6">
                          <img class="feature col-md-12 col-sm-12 col-xs-12 padd-zero img-size"  height="304" alt="one R1" src="<?php echo cdn_url_images().'/images/neighbourhoods/'.$image_s->city_id.'/'.$image_s->id.'/'.$row->small_image2; ?>"  />
                    </div>
    	...
    	<section style="padding: 0;">       
                    ...
                    <div class="col-md-4 col-sm-4 col-xs-12">
                          <img class="feature col-md-12 col-sm-12 col-xs-12 padd-zero mar-size img-size" alt="one R1"  height="286" src="<?php echo cdn_url_images().'/images/neighbourhoods/'.$image_s->city_id.'/'.$image_s->id.'/'.$row->small_image3; ?>"  />
                       </div>
                       <div class="col-md-4 col-sm-4 col-xs-12">
                          <img class="feature col-md-12 col-sm-12 col-xs-12 padd-zero mar-size img-size" alt="one R1"  height="286" src="<?php echo cdn_url_images().'/images/neighbourhoods/'.$image_s->city_id.'/'.$image_s->id.'/'.$row->small_image4; ?>"  />
                         </div>
                         <div class="col-md-4 col-sm-4 col-xs-12">
                          <img class="feature col-md-12 col-sm-12 col-xs-12 padd-zero img-size" alt="one R1"  height="286" src="<?php echo cdn_url_images().'/images/neighbourhoods/'.$image_s->city_id.'/'.$image_s->id.'/'.$row->small_image5; ?>"  />
                    </div>
    	...
    	<section style="padding: 0;">
                    ...
                    <div class="col-md-6 col-xs-12 col-sm-6">
                          <img class="feature col-md-12 col-sm-12 col-xs-12 padd-zero img-size mar-size" alt="one R1"  height="304" src="<?php echo cdn_url_images().'/images/neighbourhoods/'.$image_s->city_id.'/'.$image_s->id.'/'.$row->big_image2; ?>"  />
                   </div>
                    <div class="col-md-6 col-xs-12 col-sm-6">
                          <img class="feature col-md-12 col-sm-12 col-xs-12 padd-zero img-size"  alt="one R1"  height="304" src="<?php echo cdn_url_images().'/images/neighbourhoods/'.$image_s->city_id.'/'.$image_s->id.'/'.$row->big_image3; ?>"  />
                    </div>
    	...
    	<section class="col-md-12 col-sm-12 col-xs-12">
                	<?php 
						...
						{ ?>
                    <div class="col-md-2 col-xs-12 col-sm-2 neighbor_city_first padd-zero">
                    	<?php 
                    ...
                    <?php } ?>
                    <div class="center caption caption1 neighbor_city_middle col-md-8 col-sm-7 col-xs-12 paddng-none">
					...
					{
                    ?>
                    <div class="neighbor_city_view neighbor_city_last col-md-2 col-xs-12 col-sm-2">
  ...
  <?php      
	foreach($photographers->result() as $photographer)
	{
       ...
       <div class="container padd-zero">
                    ...
                    <div class="center caption caption1 neighbor_city_middle col-md-8 col-xs-12 col-sm-7 padd-zero">
                        <div class="primary" style=" float:left;">
                    ...
                    <div class="view neighbor_city_last col-md-2 col-xs-12 col-sm-2">
...
<div class="neighborhood-list section section-offset">
  <div class="container">
    <div class="knowthis">
      <div class="col-md-12 col-xs-12 col-sm-12 padd-zero">
...
<form class="modal in col-md-4 col-sm-4 col-xs-12 col-sm-push-4 col-md-push-4 padd-zero" id="local_know" style="display: none" method="post" action="<?php echo base_url().'neighbourhoods/local_knowledge?city='.$this->uri->segment(3).'&place='.$this->uri->segment(4);?>">
<div class="modal-header">
