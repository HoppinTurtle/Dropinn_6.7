...
<div id="neighborhood_picker" class="city-page page">
  ...
  <div class="section section-offset" style="padding: 10px 0px;">
    <div class="container padd-zero">
      ...
      <ul id="trait_selector" class="col-md-12 padd-zero">
	<?php 
	if(isset($neighbourhoods))
{
    ...
    <li data-trait-id="12" class="trait  active col-md-3 col-xs-12 col-sm-6 neigh-size">

    <a data-trait-id="12" class="premote trait-link col-xs-12 btn_list"  href="#"> <?php
...
if($neighbourhoods->num_rows()!=0)
{
        ...
        <li style="display: list-item;" data-neighborhood-permalink="kings-cross" data-neighborhood-id="1805" class="trait-tile tile cityname col-md-3 col-xs-12 col-sm-4 padd-zero">
        <div class="photo">
