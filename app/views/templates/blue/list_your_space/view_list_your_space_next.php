...
<link href="<?php echo css_url().'/style_upload.css'; ?>" media="screen" rel="stylesheet" type="text/css" />
<script  src="<?php echo base_url(); ?>js/filereader_upload.js"></script>
<script src="<?php echo base_url(); ?>js/script_upload.js"></script>
<script type="text/javascript" src="<?php echo base_url(); ?>js/tooltips_good.js"></script>
...
<script>
	...
	var cdn_url_images = '<?php echo cdn_url_images(); ?>' ;   
	var places_API = '<?php echo $places_API;?>' ;
	var verify_msg = 'Verify Location' ;
	var loc_msg = 'Is your parking space correctly located on the map?' ;
	<?php
...
<div id="mystick_head" class="header_bottom_nav">
	<div class="left_lys_ent">
        ...
        <a class="tooltip" title="<?php if($lys_status->title == 1) echo $room_type; else echo translate("$ori_room_type"); ?>">
        	<span id="title_header"><?php if($lys_status->title == 1) echo $room_type; else echo translate("$ori_room_type"); ?></span></a>
...
<div id="sidebar_main_entire" class="main_entire col-md-2 col-sm-3 col-xs-12 padding-zero">
	<div class="main_entire_inner">
        ...
        <div class="entire_contain_bottom">
            ...
            <p class="entire_title" id="detail_side"><img class="listyoursp_detail" src="<?php echo base_url(); ?>images/detail.png" /> <?php echo translate('Detail');?> 
            	...
            	<img class="plus_hv" id="detail_plus_tick" style="display: none" src="<?php echo base_url(); ?>images/tick_grn.png" />
		    </p>    
             <p class="entire_title active_entire" id="detail_side_after" style="display: none"><img src="<?php echo base_url(); ?>images/detail_hv.png" /> <?php echo translate('Detail');?>  
            	...
            	<img class="plus_hv" id="detail_plus1_after" style="display: none" src="<?php echo base_url(); ?>images/tick.png" />
            	<img class="plus_hv" id="detail_plus_grn_white" style="display: none" src="<?php echo base_url(); ?>images/tick.png" />
            	<img class="plus_hv" id="detail_grn" style="display: none" src="<?php echo base_url(); ?>images/tick_grn.png" />
            </p>
            <?php } ?> 
        ...
        <div class="entire_contain_bottom">
            ...
            <p class="entire_title" id="terms_side"><img class="listyoursp_terms" src="<?php echo base_url(); ?>images/terms.png" /> <?php echo translate('Terms');?> 
            	...
            	<img class="plus_hv" id="terms_plus_tick" style="display: none" src="<?php echo base_url(); ?>images/tick_grn.png" />
            </p>   
          <p class="entire_title active_entire" id="terms_side_after" style="display: none"><img class="listyoursp_terms" src="<?php echo base_url(); ?>images/terms_hv.png" /> <?php echo translate('Terms');?> 
            	...
            	<img class="plus_hv" id="terms_plus_after1" style="display: none" src="<?php echo base_url(); ?>images/tick.png" />
            	<img class="plus_hv" id="terms_plus_after2" style="display: none" src="<?php echo base_url(); ?>images/tick_grn.png" />
         </p>
            <?php } ?>	
  ...
  <!--<button id="list-button" class="btn-special btn-yellow-list btn_list finish next_font"></button>-->
...
<div class="center_entire col-md-6 col-sm-7 col-xs-12" id="cal_container">
  
    <div class="col-md-12 col-sm-12 col-xs-12 nopadding"  id="always" style="display: none">
    	<div>
    		<label class="cal_head"><?php echo translate('Show guests when they can book'); ?></label>
    		<label class="cal_head_inner"><?php echo translate('you can always manually update your calendar to book dates or make them available. Start by selecting the option that best describe your hosting plans'); ?></label>
    	</div>
    	<label class="cal_head"><?php echo translate('Select an Option'); ?></label>
    	<div class="col-md-12 col-sm-12 col-xs-12 nopadding all_cal_img">
    		<div class="col-md-4 col-sm-4 col-xs-6">
    			<?php if($calendar_type == 1)
				{ ?>
					<img class="cal_img update_cal" data="1" src="<?php echo base_url().'images/always_ok.png';?>" style="width:100%">
				<?php } 
else{ ?>
	<img class="cal_img update_cal" data="1" src="<?php echo base_url().'images/always.png';?>" style="width:100%">
<?php }
				?>
    			
    			<div class="cal_bottom">
    				<label class="cal_btm_head"><?php echo translate('Always Available'); ?></label>
    				<label><?php echo translate('A completely open Calendar'); ?></label>
    			</div>
    		</div>
    		<div class="col-md-4 col-sm-4 col-xs-6">
    			
    			<?php if($calendar_type == 2)
				{ ?>
					<img class="cal_img1 update_cal" data="2" src="<?php echo base_url().'images/some_ok.png';?>" style="width:100%">
				<?php } 
else{ ?>
	<img class="cal_img1 update_cal" data="2" src="<?php echo base_url().'images/sometimes.png';?>" style="width:100%">
<?php }
				?>
    			
    			<!--<img class="cal_img1 update_cal" data="2" src="<?php echo base_url().'images/sometimes.png';?>" style="width:100%">-->
    			<div class="cal_bottom">
    				<label class="cal_btm_head"><?php echo translate('Some times Available'); ?></label>
    				<label><?php echo translate('List some dates as available'); ?></label>
    			</div>
    		</div>
    		<div class="col-md-4 col-sm-4 col-xs-6">
    			
    				<?php if($calendar_type == 3)
				{ ?>
					<img class="cal_img2 update_cal" data="3" src="<?php echo base_url().'images/specific_ok.png';?>" style="width:100%">
				<?php } 
else{ ?>
	<img class="cal_img2 update_cal" data="3" src="<?php echo base_url().'images/specific.png';?>" style="width:100%">
<?php }
				?>
    			...
    			<!-- <img class="cal_img2 update_cal" data="3" src="<?php echo base_url().'images/specific.png';?>" style="width:100%"> -->
    			<div class="cal_bottom">
    				<label class="cal_btm_head"><?php echo translate('Specific Dates'); ?></label>
    				<label><?php echo translate('Only open for a single set of dates'); ?></label>
    			</div>
    		</div>	
    	</div>
    	<div class="col-md-12 col-sm-12 col-xs-12 specific_cal_img" style="display: none;">
    		<div class="col-md-12 col-sm-12 col-xs-12 nopadding specific_cal" style="border:1px solid #dbdbdb;padding:0;">
    			<div class="col-md-4 col-sm-5 col-xs-12 nopadding specific_cal_2" style="padding:0;">
	    			<img class="specific_img" src="<?php echo base_url().'images/specific_ok.png';?>">
	    		</div>
	    		<div class="col-md-8 col-sm-7 col-xs-12 nopadding cal_some_center specific_cal_3">
	    			<label class="cal_head_inner"><?php echo translate('When will your listing be available?'); ?></label>
	    			<div class="select date">
	    				<input type="text" id="start_time" name="start_time" class="select_time" placeholder="Start date">
	    			    <input type="text" id="end_time" name="end_time" class="select_time" placeholder="End date">
	    			</div>
	    			<div class="list_be_available"><label class="listAvailable"></label></div>
	    			
	    		</div>
    		</div>
    		<label style="padding:15px 0px;" id="back_cal"> << Back</label>
    		
    	</div>
    	
    	<!--  Code added here  -->
    	
    	<div class="col-md-12 col-sm-12 col-xs-12 selected_cal_img" style="display: none;">
    		
    		<div class="col-md-12 col-sm-12 col-xs-12 nopadding" style="border:1px solid #dbdbdb;padding:0;">
    			<label class="cal_head_inner" style="padding:10px 0px 0px 60px;"><?php echo translate('When will your listing blocked for guests?'); ?></label>
    			<div class="col-md-4 col-sm-5 col-xs-12 nopadding" style="padding:0;">
	    			<img class="" src="<?php echo base_url().'images/sometimes.png';?>">
	    		</div>
	    		<div class="col-md-8 col-sm-7 col-xs-12 nopadding cal_some_center" style=" padding : -40px 0px 0px 80px;">
	    			
	    			<div class="select date">
	    			<div id="selected_cal_time"   ></div>  
	    			</div>
    		...
    		<label style="padding:15px 0px;" id="back_cal1"> << Back</label>
   ...
   <div class="contain_calender" id="some_times" style="display: none">
        <div class="calendarHeader">
            <h4>
                <a class="calen_left" href="#"><i class="fa fa-arrow-circle-o-right"></i></a>
                <div class="cc" id="calendar_some"><?php echo translate('Calendar');?></div>
                <a class="calen_right" href="#"><i class="fa fa-arrow-circle-o-left"></i></a>
            </h4>
        </div>
    ...
    <div id="some_times_cal" class="edit_calender listyoursp_in col-md-12 col-sm-12 col-xs-12 padding-zero">
...
function centerLightbox() {
   ...
   var g_mouse_y = jQuery('#mouse_y').val();
    $('lwlb_calendar2').setStyle({ position:"absolute", left: (g_mouse_x - (boxWidth / 0.67) )+"px", top: (g_mouse_y - boxHeight - 153)+"px"});
}
...
function date_print_simplified(dt) {
 ...
 <input style="width:40%;" type="text" name="seasonal_price" id="seasonal_price"  value=""></p>
                        ...
                        <div class="listyoursp_price2">
                        	<p data-error="price1" class="ml-error" id="weekpriceval" style="display: none;color: #F72C37;margin-top: 25px;"><?php echo translate('week price must be greater than night price');?></p>
		...
		<p data-error="price" class="ml-error" id="large_length" style="display: none;color: #F72C37;margin-top: 25px;"><?php echo translate('Your price is too long. The maximum is 10000.');?></p>
                          ...
                          <img src="<?php echo cdn_url_images(); ?>images/spinner.gif" id="lightbox_spinner" style="display:none;"/> or <a href="#" onClick="lwlb_hide_special();return false;">Cancel</a> </div>
                      </form>
                    </div>
                  </div>
                </div>
...
<!-- edit_room -->
 ...
 <div class="center_entire price_hig col-md-6 col-sm-6 col-xs-12" id="price_container" style="display: none">
 ...
 <div style="display:none;" class="js-saving-progress saving-progress" id="price_saving">
  <h5><?php echo translate('saving...');?></h5>
	...
	<div style="" class="center_baseprice center_entire_left col-md-6 col-sm-6 col-xs-12">
	...
	<div style="" class="center_night center_entire_left col-md-6 col-sm-6 col-xs-12">
...
<?php
	   ...
	   {
       ?>
	<div style="display: none;" class="center_baseprice center_entire_left listinner_adpri col-md-6 col-sm-6 col-xs-12" id="advance_price_after">
      <?php } 
	   else { ?>
		   <div class="center_baseprice center_entire_left listinner_adpri col-md-6 col-sm-6 col-xs-12" id="advance_price_after">
	  <?php } ?>
    ...
    <?php
	   ...
	   {
       ?>
	<div style="display: none;" class="center_night center_entire_left col-md-6 col-sm-6 col-xs-12" id="advance_price_after1">
		<?php }
	   else { ?>
		<div class="center_night center_entire_left col-md-6 col-sm-6 col-xs-12" id="advance_price_after1">
<?php } ?>
         		                         <div id="loading" class="center-block">
<img src="<?php echo base_url(); ?>images/load.gif"  />
</div>
<div class="center_night center_entire_left pad_zero_list col-md-12 col-sm-12 col-xs-12">
    <div class="listinner_pri">
    ...
    <div style="display:none;" class="js-saving-progress saving-progress" id="clean_price_saving">
     <h5><?php echo translate('saving...');?></h5>
        ...
        <div class="listing_container">
            <div class="control-left listinnepri2 col-md-6 col-sm-6 col-xs-12">
				<h2>Additional Charges</h2>
				<p class="common_text">These charges are added to the reservation total.</p>
            </div>
            <div class="control-right listcont col-md-6 col-sm-6 col-xs-12">
...
<div id="js-additional-guests" class="js-tooltip-trigger">
  ...
  <div id="additional_textbox"  style="display: none">
      ...
      <div class="text-right price_add_2 pad_zero_list col-xs-12 col-md-12 col-sm-12">
...
<div id="price-right-hover" class="floatleft col-md-4 col-sm-3 col-xs-12">
...
<div style="display:none; float:right;" id="cleaning-price-right" class="main_entire_right col-md-4 col-sm-3 col-xs-12">
...
<div style="display:none;" id="additional-price-right" class="main_entire_right col-md-4 col-sm-3 col-xs-12">
...
<div class="center_entire col-md-6 col-sm-6 col-xs-12" id="overview_entire" style="display: none">
	<div class="title-overview center_entire_left overview_list col-md-6 col-sm-6 col-xs-12" >
	...
	<div class="summary-overview center_entire_left  col-md-6 col-sm-6 col-xs-12" style="">
    <div>
...
<div class="floatleft col-md-4 col-sm-3 col-xs-12" style="display: none;" id="overview-textbox-hover">
<div id="overview-text-right" style="" class="main_entire_right">
	<div class="main_entire_right_inner listinner_price">
...
<div style="display:none;" id="summary-text-hover" class="main_entire_right col-md-12 col-sm-12 col-xs-12 padding-zero">
<div class="main_entire_right_inner listinner_price">
    	<p class="thimbthumb"><img src="<?php echo base_url(); ?>images/thimbthumb_new.png" /><b class="head-hover"> <?php echo translate("A great summary");?></b></p>
        <div class="inner_entire">
...
<!-- detail -->
        ...
        <div class="center_entire col-md-6 col-sm-6 col-xs-12" id="detail_container" style="display: none">
        	<div class="listinner_pri">
...
<div class="floatleft col-md-4 col-sm-3 col-xs-12" id="details-textbox-hover">
...
<div id="ded" style="display:none" id="details_text_hover" class="main_entire_right col-md-12 col-sm-12 col-xs-12">
<div class="main_entire_right_inner listinner_price">
...
<!-- Terms -->
        ...
        <div class="center_entire col-md-6 col-sm-6 col-xs-12" id="terms_container" style="display: none">
        	 <div class="listinner_pri">
 <div style="display:none;" class="js-saving-progress saving-progress" id="policy_saving">
  <h5><?php echo translate('saving...');?></h5>
        ...
        <div class="listing_container">
            <div class="control-left listcomment col-md-6 col-sm-6 col-xs-12">
				<h2>Terms</h2>
				<p class="common_text">The requirements and conditions to book a reservation at your listing. </p>
            </div>
            <div class="control-right listcount col-md-6 col-sm-6 col-xs-12">
...
<div class="center_entire col-md-6 col-sm-6 col-xs-12" id="amenities_entire" style="display: none">
    ...
    <div style="display:none;" class="js-saving-progress saving-progress" id="amenities_saving">
     <h5><?php echo translate("saving...");?></h5>
          ...
          <div class="control-group">
                ...
                <div class="amenities-control col-md-6 col-sm-6 col-xs-12">
                <?php
                if($result_amenites != '')
					{
...
<div class="center_entire col-md-6 col-sm-6 col-xs-12" id="listing_entire" style="display: none">
    <div class="listing">
    <div class="listinner_pri">
            ...
            <div class="control-right  col-md-6 col-sm-6 col-xs-12">
                ...
                <div class="list-type">
                    ...
                    <select class="control_select-box" id="room_type_drop">
                       <?php  
					$room = $this->db->get('room_type');
					foreach($room->result() as $value) {
						  ?> <option <?php if($room_type == $value->type) echo 'selected'; ?>><?php echo $value->type;?></option>
					<?php }?>
                    </select>
                </div>
...
<p class="hr_center"></p>
	...
	<option value="Real Bed" <?php if($bed_type == 'Real Bed') echo 'selected'; ?>><?php echo translate_admin("Real Bed");?></option>
                ...
                <style>
                 ...
                 <div class="list-type_bed">
                   		<p class="control-list"><?php echo translate("Minimum stay (Optional)");?></p>
                    <input type="text"  class="control_select-box stay" id="min_stay"   onkeypress="return isNumberKey(event)" value="<?php if($min_stay > 0){ echo $min_stay; } else { echo ""; } ?>"/> <span id="nit">&nbsp;nights</span>
                    </div>
                    <p data-error="min_stay_error" class="ml-error" id="minstay0" style="display: none;color: #F72C37;margin-top: 10px;"><?php echo translate('Minimum stay should not be zero');?></p>
                    <p data-error="min_stay_error" class="ml-error" id="minstay" style="display: none;color: #F72C37;margin-top: 10px;"><?php echo translate('Minimum Stay value should be less then maximum stay');?></p>
                    <div class="list-type_bed">
                   		<p class="control-list"><?php echo translate("Maximum stay (Optional)");?></p>
                    <input type="text" class="control_select-box stay1"  id="max_stay" onkeypress="return isNumberKey(event)" value="<?php if($max_stay > 0){ echo $max_stay;  } else { echo ""; } ?>"    /><span id="nit">&nbsp;nights</span>
                    </div>
					<p data-error="max_stay_error" class="ml-error" id="maxstay0" style="display: none;color: #F72C37;margin-top: 10px;"><?php echo translate('Maximum stay should not be zero');?></p>
					<p data-error="max_stay_error" class="ml-error" id="maxstay" style="display: none;color: #F72C37;margin-top: 10px;"><?php echo translate('Maximum stay value should be greater then minimum stay');?></p>
            </div>
...
<!--<div class="center_entire col-md-6 col-sm-6 col-xs-12" id="photos_container" style="display: none">-->

<!--Drag and Drop image upload 1 start-->

<div class="center_entire span12 col-md-6 col-sm-6 col-xs-12" id="photos_container" style="display: none">

		<div id="dropbox" style="margin:0px;">
		
		<div style="text-align: center; margin: 0 auto;">
			<p class="drop_img list_drop">Drop Images Here</p>
		</div>
	</div>
   ...
   <ul class="photo_img" id="photo_ul" style="display: none">
   	...
   	if($list_photo->num_rows() != 0)
	{
   	foreach($list_photo->result() as $row)
     {
      ...
      <li class="photo_img_sub span4" id="<?php echo $row->id; ?>">
     ...
     <!--Drag and Drop image upload 3 start(replace)-->
...
<!--Drag and Drop image upload 3 stop-->
        <i ><img src="<?php echo css_url(); ?>/images/delete-32.png"></i>
      </button>
      <div class="panel-body panel-condensed">
      <textarea name="" id="highlight_<?php echo $row->id;?>" rows="3" placeholder="<?php echo translate('What are the highlights of this photo?');?>" class="input-large" onKeyUp="jQuery(this).highlight('<?php echo $row->id;?>')"><?php echo trim($row->highlights); ?></textarea>
      </div>
      </div>
      </li>
   <?php
...
<!--Drag and Drop image upload 1 end-->
   ...
   <!-- Video grabber 1 start -->
         <div class="video">
   	<h3 class="vdeo_hdng"><?php echo translate("Add a Video"); ?></h3>
      	<img src="<?php echo css_url(); ?>/images/youtube.png" />
      	<div class="add_vdeo">
      		<label><b>Property Video</b></label>
    	 	<input type="text" id="video_upload" class="list_videurl" value="<?php echo $video_code;?>" name="video_upload" placeholder="enter youtube URL here"/>
    	 	<input type="hidden" id="id" name="id" value=" <?php echo $room_id;?>"/>
         	<button id="videoupload" class="videoupload btn_list">Save Video</button>
         	
       	         <button id="youdel" ><i><img src="<?php echo css_url(); ?>/images/delete-32.png"></i></button>

          

         	<p>Upload your video to your youtube.com channel and then just insert the video URL in the field above. It will look something like this:<label style="color:#7f1111;"> https://www.youtube.com/watch?v=-xsDAxevQeM</label></p>
         </div>
          <!-- Video grabber 1 end -->
...
jQuery(document).ready(function(){
    jQuery("#youdel").click(function(){
	var room_id = jQuery('#id').val();

var dataes= jQuery('#video_upload').val();
...
else
{
 jQuery.ajax({
   type: "POST",
   url: "<?php echo base_url();?>index.php/rooms/youtube_delete",
   data:{'some':room_id},
    success  : function (data)
         {
     jQuery('#video_upload').val("");
...
//end youtube
	        ...
	        jQuery('#videoupload').live('click', function() {
   	
	var room_id = jQuery('#id').val();
	
   		var videourl = jQuery('#video_upload').val();
   	...
   	if(videourl == '' || videourl==' '){
   		...
   		}else if(videourl.match(matches)){
   			
   			   jQuery.ajax({
      	
         url:'<?php echo base_url().'rooms/youtube_data_grabber'?>',
      //   secureuri      :false,
        // fileElementId  :'video_upload',
         type: 'POST',
         data: { 'video_upload' : videourl.replace(re, 'http://www.youtube.com/watch?v=$1'),'room_id':room_id },
       // dataType: 'text',
         success  : function (data)
         {
...
<div class="center_entire col-md-6 col-sm-6 col-xs-12 lst_pho" id="address_entire" style="display: none">
	<div class="title-address center_entire_left nofiles col-md-6 col-sm-6 col-xs-12">
	...
	<div class="lys_address col-md-6 col-sm-6 col-xs-12 padding-zero">
		<?php
		if($street_address != '')
		{
			?>
...
<div id="static_circle_map" class="main_entire_right mainenter col-md-4 col-sm-3 col-xs-12" style="display: none; float:right;">
	<div class="main_entire_right_inner">
    	<p class="thimbthumb"><img src="<?php echo base_url(); ?>images/thimbthumb_new.png" /> <?php echo translate("Your Address is Private");?></p>
        <div class="inner_entire">
    	<p class="text_inner"><?php echo translate("It will only be shared with guests after a reservation is confirmed.");?></p>
			...
			<img width="210" height="210" id="static_circle_map_img" src='<?php $cmap=$MapURL.'&key='.$places_API; echo $cmap;   ?>' />
			
		
		<p class="text_inner text_inner1">
		<?php echo translate("This is how your location appears on your listing page.");?> 
		<span class="viewlist"><a href="<?php echo base_url().'rooms/'.$room_id;?>"> <?php echo translate("View on listing page");?> »</a></span>
				</p>
...
<input type="hidden" name="hidden_lng" id="hidden_lng"/>
  <div class="row-space-2">
    ...
    <input type="text" placeholder="e.g. Apt #7" class="input-large" value="<?php echo $optional_address; ?>" id="street_number" name="apt">
  </div>

  <div class="row-space-2">
    <label for="city" class="label-large"><?php echo translate("City");?></label>
    <input type="text" placeholder="e.g. San Francisco" id="locality" class="input-large" value="<?php echo $city; ?>" name="city">
  </div>

  <div class="row-space-2">
    <label for="state" class="label-large"><?php echo translate("State");?></label>
    <input type="text" placeholder="e.g. CA" id="administrative_area_level_1" class="input-large" value="<?php echo $state; ?>" name="state">
  </div>
  
  <div class="row-space-2">
    <label for="zipcode" class="label-large"><?php echo translate("ZIP Code");?></label>
    <input type="text" placeholder="e.g. 94103" class="input-large" value="<?php echo $zipcode; ?>" id="postal_code" name="zipcode" onkeypress="return (event.which >= 48 && event.which <= 57)     || event.which == 8 || event.which == 46">
  <input type="hidden" placeholder="Example: 46002" class="input-large" id="postal_code_prefix" name="zipcode_prefix">
  </div>
<input type="hidden" class="input-large" id="route" name="route">
<input type="hidden" class="input-large" id="neighborhood" name="neighborhood">
<input type="hidden" class="input-large" id="district" name="district">
</div>
<!--</form>-->
</div>
</div>
...
else
{
	$list_is_featured_photo = '';
      	...
      	?>
        <div  class="modal-seelist-img modal-body-list modal-body-picture-list" id="final_photo" style="background: url(<?php echo base_url().'images/'.$room_id.'/'.$list_is_featured_photo; ?>); background-repeat:no-repeat; background-size:cover">
        </div>
        <div class="modal-body-list modal-body-content-list text-center-list row-table-list">
          <div class="col-middle-list">
...
<script>
 var sort ; 
 sort = function () {
 jQuery('.ul_overflow ul').sortable({
 	    axis: 'z',
        handle: 'div',
        connectWith:['.ul_overflow ul'],
        update:function(event, ui) {
        var photo_sortable =jQuery(".ul_overflow ul").sortable('toArray').toString();
    		//alert(photo_sortable);

           jQuery.ajax({
                url: base_url + "rooms/photo_drag",
                type: 'POST',
                data: {item_id:photo_sortable,room_id:room_id},
                success: function(data) {
                	var str = e.trim();
                                        ...
                                        if (e != "no_image.jpg") {
                                        	jQuery("#final_photo").replaceWith('<div  class="modal-seelist-img modal-body-list modal-body-picture-list" id="final_photo" style="background: url('+base_url+"images/"+room_id+"/"+e+'); background-repeat:no-repeat; background-size:cover"></div>')
                                        } else {
                                            jQuery("#final_photo").replaceWith('<div  class="modal-seelist-img modal-body-list modal-body-picture-list" id="final_photo" style="background: url(' + base_url + "images/" + e + '); background-repeat:no-repeat; background-size:cover"></div>')
                                        }
 ...
 jQuery(document).ready(function(){
 	jQuery.ajax({
 		...
 		success: function(e){
 			...
 			if(e.type==1){
 				jQuery('.cal_img').attr('src',"<?php echo base_url().'images/always_ok.png';?>");
				jQuery('.cal_img1').attr('src',"<?php echo base_url().'images/sometimes.png';?>");
				jQuery('.cal_img2').attr('src',"<?php echo base_url().'images/specific.png';?>");
 			} else if(e.type==2){
 				jQuery('.cal_img').attr('src',"<?php echo base_url().'images/always.png';?>");
				jQuery('.cal_img1').attr('src',"<?php echo base_url().'images/some_ok.png';?>");
				jQuery('.cal_img2').attr('src',"<?php echo base_url().'images/specific.png';?>");
				jQuery('.all_cal_img').hide();
				jQuery('.selected_cal_img').show();
 			} else if(e.type==3){
 				jQuery('.cal_img').attr('src',"<?php echo base_url().'images/always.png';?>");
				jQuery('.cal_img1').attr('src',"<?php echo base_url().'images/sometimes.png';?>");
				jQuery('.cal_img2').attr('src',"<?php echo base_url().'images/specific_ok.png';?>");
				//alert(e.start_time);
				jQuery('#start_time.select_time').val(e.end_date);
				jQuery('#end_time.select_time').val(e.start_date);
				jQuery('.all_cal_img').hide();
				jQuery('.specific_cal_img').show();
 			}
 		}
 	})
 });	
jQuery(".cal_img").click(function(){
	jQuery('.cal_img').attr('src',"<?php echo base_url().'images/always_ok.png';?>");
	jQuery('.cal_img1').attr('src',"<?php echo base_url().'images/sometimes.png';?>");
	jQuery('.cal_img2').attr('src',"<?php echo base_url().'images/specific.png';?>");         
});
jQuery(".cal_img1").click(function(){
	jQuery('.cal_img').attr('src',"<?php echo base_url().'images/always.png';?>");
	jQuery('.cal_img1').attr('src',"<?php echo base_url().'images/some_ok.png';?>");
	jQuery('.cal_img2').attr('src',"<?php echo base_url().'images/specific.png';?>");
	jQuery('.all_cal_img').hide();
...
jQuery(".cal_img2").click(function(){
	jQuery('.cal_img').attr('src',"<?php echo base_url().'images/always.png';?>");
	jQuery('.cal_img1').attr('src',"<?php echo base_url().'images/sometimes.png';?>");
	jQuery('.cal_img2').attr('src',"<?php echo base_url().'images/specific_ok.png';?>");
	jQuery('.all_cal_img').hide();
...
jQuery("#back_cal").click(function(){
	jQuery('.all_cal_img').show();
	jQuery('.specific_cal_img').hide();
});
jQuery("#back_cal1").click(function(){
	jQuery('.all_cal_img').show();
	jQuery('.selected_cal_img').hide();
});
</script>
...
/*.modal-body_img-list, .modal-body_img{
	background-image: url("Cloud_data/images/welcome.png") !important;
}*/
...
jQuery(document).ready(function()
    {
    	jQuery('.modal-body_img-list').css('background-image',"url(<?php echo base_url();?>images/welcome.png)");
    	//jQuery(".modal-body_img-list").css('background-image',"url(<?php echo base_url();?>images/welcome.png)");
	 	//jQuery(".modal-body_img").css('background-image',"url(<?php echo base_url();?>images/welcome.png)");
	 	jQuery('.modal-body_img').css('background-image',"url(<?php echo base_url();?>images/welcome.png)");
	 	
	 
    	
    jQuery("#selected_cal_time").datepicker({
    	changeMonth :true,
    	changeYear : true ,
...
{  	
	 	...
	 	jQuery.ajax({
 		url: base_url+'calendar/blocked_calendar',
 		type: 'POST',
 		data: {
 			list_id: <?php echo $room_id; ?>
 		},
 		success: function(e){
	var	 mydates= e;
...
function addOrRemoveDate(date,inst) 
{
	...
	if (jQuery.inArray(date,dates) != -1)
	{
		...
		inst.dpDiv.removeClass('selected_cal');
		remove_block(date);
	}
	else
	{
...
function padNumber(number) {
 ...
 var block_specific = function($dates){
 	current_date=$dates;
 	
 	jQuery.ajax({
 		url: base_url+'calendar/block_dates',
 		type: 'POST',
 		data: {
 			list_id: <?php echo $room_id; ?>,
 		...
 		jQuery('#selected_cal_time').datepicker('refresh');	
 		
 		}
 	})
 }

 var remove_block = function($dates){
 	current_date=$dates;
 	jQuery.ajax({
 		url: base_url+'calendar/remove_block',
 		type: 'POST',
 		data: {
 			list_id: <?php echo $room_id; ?>,
 			current_date : current_date
 ...
 jQuery( "#start_time" ).datepicker({
    ...
    numberOfMonths: 1,
    onSelect: function(dateText, inst) { 
    d = jQuery('#start_time').datepicker('getDate');
	d.setDate(d.getDate()+1); // add int nights to int date
	jQuery("#end_time").datepicker("option", "minDate", d);
	setTimeout(function () {
         jQuery("#end_time").datepicker("show")
         }, 0)
     }
 });
 ...
 var insert_specific = function(){
 	start_date = jQuery('#start_time').val();
 	end_date = jQuery('#end_time').val();
 	jQuery.ajax({
 		url: base_url+'calendar/specific_dates',
 		type: 'POST',
 		data: {
 			list_id: <?php echo $room_id; ?>,
 		...
 		success: function(e){
 			jQuery('.listAvailable').fadeIn();
 			jQuery('.listAvailable').text(e);
 			jQuery('.listAvailable').fadeOut(5000);
 		}
 	})
 }
 /* isNumberKey
