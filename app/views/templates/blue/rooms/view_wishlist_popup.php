...
<div class="modal_save_to_wishlist col-md-12 col-sm-12 col-xs-12" style="display: none;">
	<div class="modal-table col-md-6 col-md-offset-2">
	<div class="modal-cell"><div class="new-modal wishlist-modal modal-content show_share_fb_checkbox col-md-6 col-md-offset-3 padding-zero" style="width:100%;">
  <div class="panel-header col-md-12 col-sm-12 col-xs-12 ">
 ...
 <input type="hidden" value="<?php echo $list_id; ?>" id="hidden_room_id">
  <div class="panel-body" style="overflow: hidden;">
    <div class="row col-md-12 col-sm-12 col-xs-12 padding-zero" style="padding-top:10px" id="panel-body">
      <div class="col-md-2 col-sm-2 col-xs-3 padding-zero">
        <div class="media-photo media-photo-block dynamic-listing-photo-container">
          <div class="media-cover text-center">
          	<?php $noimage = base_url()."images/no_image.jpg"; ?>
            <img class="dynamic-listing-photo img-responsive-height" src="<?php echo $images;?>" onerror="this.src='<?php echo $noimage;?>'">
          </div>
        </div>
      </div>

      <div class="wishlist col-md-10 col-sm-10 col-xs-9 " style="min-height: 398px;">
	...
	if($wishlist_category->num_rows() != 0)
				...
				echo '</ul>';
?>
                <div class="newWLContainer col-md-12 col-sm-12 col-xs-12" style="min-height: 90%;">
                  ...
                  <div style="display:none" id="new_wishlist">
                    ...
                    <div class="row" style="margin-left:0 !important;">
                      <div class="col-md-6 col-sm-6 col-xs-12 padding-zero" style="margin-bottom: 5px">
                        <input type="text" placeholder="Make a new wish list..." size="26" id="wishlist_category_name" style="width: 100%;">
                      </div>
                      <div class="col-md-6 col-sm-6 col-xs-12 padding-zero" style="">
                        <div class="select save_pop" style="vertical-align: top !important;">
                          <select class="wishlist-create-privacy wishlist-text" name="private" id="privacy">
                      ...
                      <!--  <i style="line-height: 2;margin-left: 12px;margin-right: 5px;" class="fa fa-question-circle fa-1g" id="privacy-tooltip-trigger"></i> 
                   ...
                   <img height="15" width="15" title="Everyone &#xA;Visible to everyone and included on your public profile.&#xA;Only Me&#xA;Visible only to you and not shared anywhere." src="<?php echo base_url().'images/question_mark_2.png'; ?>" class="anchor-s">
                  <button class="btn_dash finish createWishlist save_pop1 create-btn" style="padding: 6px 12px;" id="wishlist_category">Create</button>
                      </div>
                    </div>
                  </div>
                </div>
        ...
        <div id="add_note">
          <div class="noteContainer col-md-12 col-sm-12 col-xs-12 padding-zero">
  ...
  <div class="panel-footer">
  	...
  	if(isset($status))
	{
		...
		{
		?>
    <button class="blue gotomsg btn_dash" id="wishlist_save_account" type="submit" onclick="window.location.reload()">Save</button>
    <?php 
		}
		else if($status == 'home')
		{
		?>
	<button class="blue gotomsg btn_dash" id="wishlist_save_home" type="submit" onclick="window.location.reload()">Save</button>
	...
	<?php
    	...
    	{	
    	?>
    <button class="blue gotomsg btn_dash" id="wishlist_save_rooms" type="submit" onclick="window.location.reload()">Save</button>
...
#privacy-tooltip-trigger::before #privacy-tooltip{
	display: block;
}

#privacy-tooltip-trigger:hover + .panel-body{
    display:block !important;
    z-index:3000;
    float:left;
    margin:90px 0px 0px 244px;
}
i:hover + #privacy-tooltip-trigger{
	display: block;
	z-index: 1;
}
.wishlist {
