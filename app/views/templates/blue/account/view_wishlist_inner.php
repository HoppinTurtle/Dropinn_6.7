...
#slider4 .viewwish.img_bor {
    opacity: 1 !important;
}
.panel-image.listing-img.img-large {
    z-index: -2147483648;
}
.media-photo.media-cover.wishlist-bg-img{
...
.h5.listing-name.text-truncate.row-space-top-1{
...
<div id="dashboard_container">
	<div class="Box">
		<div class="Box_Content" id="box_content">
			...
			<div class="top-bar">
    <div class="col-md-7 col-sm-7 col-xs-12 img-bot padding-zero">
  ...
  <div class="media-body">
    <div class="wishlist-header-text">
      <div class="col-md-12 col-sm-12 col-xs-12 col-middle">
      	<?php
      	if($check_user == 0)
		{
		?>
    ...
    <div class="col-middle socialshare col-md-5 col-sm-5 col-xs-12 padding-zero">
...
<a href="#" class="share-btn share-envelope-btn">
  ...
  ?>
   ...
   <!--   <a data-view="list" class="btn gray" id="list_view" style="float:left;opacity: 0.45;margin-right: 6px;" href="#list_view">List View</a>
    ...
    <div class="col-middle col-md-12 col-sm-12 col-xs-12 padding-zero top_margin">
  <?php
  if($check_user == 1)
  {
  ?>
  <ul class="results-list list-unstyled col-md-12 col-sm-12 col-xs-12 padding-zero" id="list_div">
  	<?php
...
$('.prev').click(function()
{
    ...
    if(hashVal == 'list_view')
    {
  	...
  	<li class="col-md-12 col-sm-12 col-xs-12 padding-zero" id="li_<?php echo $row->list_id;?>" style="overflow: inherit;">
  		<label for="<?php echo $row->list_id;?>" class="col-md-12 col-sm-12 col-xs-12 padding-zero">
...
if($image->num_rows() != 0)
{
	foreach($image->result() as $image_list)
	{
		...
		$pieces  = explode(".", $name);
		$image = cdn_url_images().'w_350,h_200/w_350/images/'.$image_list->list_id.'/'.$pieces[0].'.jpg';
	  ...
	  $date_new = strtotime(date("Y-m-d", strtotime("-3 days")));
						               ...
						               <?php if($created >= $date_new ){ ?>
						                		...
						                		<?php  }  ?>
	<img class="viewwish img_bor" width="216" height="144" data="<?php echo $j;?>" alt="" src="<?php echo $image;?>" onerror="this.src='<?php echo $noimage;?>'">
	</li>
		<?php
	}
...
<a class="photo-paginate next" href="javascript:void(0);"><i></i></a>
    ...
    <div class="col-md-9 col-sm-9 col-xs-12">
      <div class="room-info col-md-12 col-sm-12 col-xs-12 padding-zero">
        ...
        <div class="col-md-3 col-sm-3 col-xs-12 padding-zero break">
          <div class="text-center">
            <sup class="h5"></sup>
            <span class="h2 price-amount"><?php echo get_currency_value1($row->list_id,$row->price);?></span>
            <sup class="h5"><?php echo get_currency_symbol(1); ?></sup>
            <br>
      ...
      <div class="">
        <div class="media col-md-8 col-sm-8 col-xs-12 padding-zero space">
...
<div class="wishlists-container page-container row-space-top-4">
	<div class="edit_view row-space-8">
		<div class="row-space-4 col-md-12 col-sm-12 col-xs-12 padding-zero">
  <div class="col-md-12 col-sm-12 col-xs-12 padding-zero">
...
<div class="wishlists-body col-md-12 col-sm-12 col-xs-12 padding-zero">
  <div class="wishlist_main col-md-4 col-sm-4 col-xs-12">
    <div class="panel">
  	...
  	<?php
			...
			if($user_wishlist->num_rows() != 0)
			{
			   ...
			   if($data['images']->num_rows() != 0)
			   {
				...
				$pieces = explode(".", $name);
			   	 $image = base_url().'w_350,h_200/w_350/images/'.$user_wishlist->row()->list_id.'/'.$pieces[0].'.jpg';
			   }
			   else
			   	{
  ...
  <!--<div style="background-image:url(<?php echo base_url();?>);" class="media-cover media-cover-dark wishlist-bg-img">
    ...
    <div class="row-table row-full-height col-md-12 col-sx-12 col-xs-12">
      <div class="col-12 col-middle text-contrast checkin">
  ...
  <div class="col-md-8 col-sm-8 col-xs-12">
      <div class="row-space-2 col-md-12 col-sm-12 col-xs-12 padding-zero">
        <div class="col-md-12 col-sm-12 col-xs-12 padding-zero">
          <div class="panel">
          ...
          <!--  <div class="panel-body" style="padding-top:16px;padding-bottom:90px;box-shadow: 0 3px 3px 0 rgba(0, 0, 0, 0.15);">-->
              ...
              <div class="col-md-12 col-sm-12 col-xs-12 padding-zero">
                <div class="col-md-6 col-sm-6 col-xs-12 wishmain">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12 listbutton padding-zero_12">
                  <label for="wishlist-edit-privacy-setting" style="display: block;">Who can see this?</label>
                  <div class="padding-zero_12">
...
#share-via-email .modal-table {
    width: 100%;
}
#share-via-email .modal-cell {
    padding: 20px;
    width: 100%;
}
}
...
#email_share_form .input-large ,#email_share_form #email_message{
    font-size: 11px;
}
}
.wishlist-button .search_heart {
