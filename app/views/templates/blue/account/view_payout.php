    ...
    <div class="Box_Content">
     ...
     <table id="payout_methods" class="clsTable_View res_table" cellpadding="5" cellspacing="0" width="100%">
        <thead>
          ...
          <tr>
            <td><?php            
       		$res =	$this->Common_model->getTableData( 'payments', array("id"=> $row->payout_type) )->row(); 
            echo $res->payment_name; ?></td>
      ...
      <!--Payment Method-->
      <div style="display:none;" id="payout_country_select" class="col-md-5 col-sm-8 pad_em_list">
