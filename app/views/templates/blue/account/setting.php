		    	...
		    	<div class="Box" id="hide_div">
		    		...
		    		<div style="padding:15px 0px;">
		    			<input type="submit" id="cancel_account" class="btn_dash finish setting" name="cancel_account" value="Cancel account"/>
					       ...
					       <div id="cancel_account1" class="Box col-md-12 col-sm-12 col-xs-12 ">	
						      <h2 class="setting_head">Tell us why you're leaving</h2>
										
									<div class="row-space-2 col-md-12 col-sm-12 col-xs-12" style="padding:0px 15px">
								             <label for="reason_safety_concerns" class="col-md-12 col-sm-12 col-xs-12 padding-zero"><br>
								                     <input name="reason" type="radio" value="User have safety concerns" />
								                      I have safety concerns.<br />
								               </label>
								               <label for="reason_privacy_concerns" class="col-md-12 col-sm-12 col-xs-12 padding-zero"><br>
								                     <input  name="reason"  type="radio" value="User have privacy concerns" />
								                     I have privacy concerns.<br />
								                </label>
								                <label for="reason_not_useful" class="col-md-12 col-sm-12 col-xs-12 padding-zero"><br>
								                     <input name="reason" type="radio" value="User don't find it useful" />
								                     I don't find it useful.<br />
								                </label>
								               <label for="reason_dont_understand_how_to_use" class="col-md-12 col-sm-12 col-xs-12 padding-zero"><br>
								                      <input  name="reason" type="radio" value="User don't understand how to use it" />
								                      I don't understand how to use it.<br />
								               </label>
								               <label for="reason_temporary" class="col-md-12 col-sm-12 col-xs-12 padding-zero"><br>
								                     <input name="reason"  type="radio" value="It's temporary; User will be back"  />
								                     It's temporary; I'll be back.<br />
								                      </label>
								               <label for="reason_other" class="col-md-12 col-sm-12 col-xs-12 padding-zero"><br>
								                      <input name="reason"  type="radio" value="Other" />
								                      Other
								                      </label>           
								     </div>
								     <div class="row-space-2 col-md-12 col-sm-12 col-xs-12 " style="padding:15px 15px 20px">
												   <label for="details" class="col-md-12 col-sm-12 col-xs-12 padding-zero">
												   	   <br>Care to tell us more?<br><br>
												   </label>
												   <textarea class="input-block col-md-5 col-sm-5 col-xs-12 padding-zero" id="details" cols="50" rows="7" name="details" value=""></textarea>
								      </div>
