...
<div id="dashboard_container" class="col-sm-9 col-md-9 col-xs-12">
    <div class="Box" id="View_Transaction">
    	<div class="Box_Head msgbg tran-list">
    		...
    		<select class="payout-method select_pay col-md-3 col-xs-8 col-sm-4">
        ...
        <select class="payout-listing select_pay col-md-3 col-xs-8 col-sm-4">
        ...
        <select class="payout-year select_pay col-md-2 col-xs-8 col-sm-4">
        ...
        <select class="payout-month select_pay col-md-3 col-xs-8 col-sm-4">
