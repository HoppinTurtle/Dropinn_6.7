<style>
	body {
/*background: url("../Cloud_data/images/friends-callout.jpg") repeat-x scroll center 82px #F3F9FD;*/ */
}
...
echo '<div class="landette container col-xs-12">';*/
echo '<div class="container friend_invites">';
echo '<div class="bg_images">';
echo '<div class="col-xs-12 frient_text"><p>'.translate("See what your friends are saving to their Wish Lists on").' '.$this->dx_auth->get_site_title().'!</p></div>';


echo "<div class='fb-conntect col-xs-12 frient_fb'>";
echo '<button class="btn fb-blue facebook_me" id="facebook" class="facebook" onclick="facebook()">
	<span class="icon-container">
		<i class="icon icon-facebook"></i>
	</span>
<span class="fb-img">Connect with facebook</span></button></div>';
echo '<div class="col-xs-2"></div></div>';
echo '<div class="col-xs-12 backgd_img">' ;

echo '<img class="background-pic" src="'.base_url().'images/friends-callout.jpg"/></div>';
...
echo '<div class="friends-feed_sub col-md-6 col-xs-12 col-sm-6 "><img src="'.base_url().'images/banner4.jpg"  />';
...
//echo '<div class="landette-sub">';
echo '<div class="friends-feed_sub col-md-6 col-xs-12 col-sm-6 " ><img src="'.base_url().'images/banner3.png"  />';
...
echo '<div class="friends-feed1 col-md-12 col-sm-12 col-xs-12"><div class="whole"><img src="'.base_url().'images/friends-feed-map.jpg" width="100%" />';
echo '</div>';
echo '</div>';
echo '</div>';
echo '</div>';
