...
#full_verify p.full_content {
    font-size: 15px;
    font-weight: normal !important;
}
#full_verify .inner_verify > h3 {
    color: rgb(57, 60, 61);
    font-size: 22px;
    }
.inner_verify .btn_dash {
    margin: 10px 0;
}    
 ...
 /*   document.getElementById('name').innerHTML = profile['displayName'];
  ...
  function render() {
	...
	<div id="display" style="margin: 30px 0 0 0;">
            <div class="container" id="container" style="margin-bottom:25px;" >
               <div class="full_verify col-md-9 col-sm-9 col-xs-12" id="full_verify">
        ...
        <div class="inner_verify">
          ...
          <div class="shadow col-md-12 col-sm-12 col-xs-12 padd-zero">
            <ul class="verification-summary">
                ...
                <li class="default"><i class="icon-green fa fa-check-circle fa-1g"></i>
                	...
                	<span><?php echo translate('Verify your Facebook address');?></span></li>
                <?php } ?>
                <?php 
                      if($users->google_verify != 'yes')
					  { ?> 
                <li class="default"><i class="icon-green fa fa-check-circle fa-1g"></i>
                	<!--<img src='<?php echo base_url()."images/nott_success.png"?>' />-->
                		<span><?php echo translate('Verify your Google address');?></span></li>
               <?php } ?>
               <?php 
                      if($users->email_verify != 'yes')
					  { ?> 
				<li class="default"><i class="icon-green fa fa-check-circle fa-1g"></i>
				<span><?php echo translate('Verify your email address');?></span></li>
           <?php } 
               if($users->phone_verify != 'yes')
					  { ?> 
				<li class="default"><i class="icon-green fa fa-check-circle fa-1g"></i>
					<span><?php echo translate('Verify your Phone Number');?></span></li>
           <?php } ?>
            </ul>
           </div>
	...
	<div id="profile" style="display:none;">
            <div class="box_verify col-md-9 col-sm-9 col-xs-12 padd-zero">
                <div class="box_me">
              ...
              ?>
                ...
                <div class="email" id="phone_verify" style="display: none;">
                    <div class="verify_me">
                            <a id="add_phone_no" class="btn_dash_green" href="#"><?php echo translate('Phone Number');?></a>
  ...
  <div class="pnaw-step2" style="display:none;">
    ...
    <p class="cancel-message">If it doesn't arrive, click cancel and try again.</p>
                ...
                <div class="back  col-md-12 col-xs-12 col-sm-12 padding-zero" >
                    <a href="#" onClick="back()" class="btn_dash"><?php echo translate('Back');?></a>
                </div>
        </div>
    </div>
</div>
            <div class="full_verify_right col-md-3 col-sm-3 col-xs-12">
                <div class="span_verify col-md-12 col-xs-12 col-sm-12 pad-edit" data-cid="view29" data-view="progress_widget">
                ...
                <div class="verification_picture col-md-12 col-xs-12 col-sm-12" style="padding: 5px;text-align: center;">
                ...
                <div class="verification_details col-md-12 col-xs-12 col-sm-12" id="verification_details_bar">
               ...
               $count = json_decode($json, TRUE);	
						...
						if($users->phone_verify == 'yes')
                        {
                            echo ' <p class="title">'.translate('Phone Number').'</p><p class="" style="color: #82888a;padding:0 0 0 6px;">▒▒▒▒▒▒▒▒▒▒ '.$phone_number.'</p>';
                        }
