...
<div style="width:100%;">
		<div class="neighbourhoods">
        		<ul>
    <li class="col-md-12 col-sm-12 col-xs-12 fullwidth370 Text-ellipsis1"><h1 class="neighborhoods">';?><?php echo translate("No Neighborhoods");?><?php echo '</h1></li>
  </ul>
...
{
?>
<li class="col-md-3 col-sm-4 col-xs-12 fullwidth370 Text-ellipsis1"><ul class="nei_country_line">

<!--<a href="<?php echo site_url()."rooms/".$row->id; ?>"></a>-->
<li class="col-md-12 col-sm-12 col-xs-12 nopadding Text-ellipsis1">
