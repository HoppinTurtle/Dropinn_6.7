...
<div class="container">
<div class="container_bg container col-md-12 col-sm-12 col-xs-12" id="View_Canellation_Policy">
<div class="cancel_head_content col-md-12 col-sm-12 col-xs-12">
...
<div class="Box col-md-12 col-sm-12 col-xs-12 can_pad">
	<div class="Box_Head">
		<?php
		foreach($cancellationDetails->result() as $row)
		{
		?>
		<ul class="col-md-2 col-sm-2 col-xs-12 can_pad can_list" id="<?php echo $row->id;?>">
	...
	<div id="Box_Content<?php echo $cancellation->id ?>" class="Box_Content <?php echo str_replace(' ','-',$cancellation->name);?>">
		<h3>
         ...
         ?>
        <div class="timeline-container hide-phone col-md-12 col-sm-12 can_pad" id="bar_<?php echo $cancellation->id;?>">
...
<div class="row-fluid row-flush clearfix space2" id="bar_content_<?php echo $cancellation->id;?>">
      ...
      if(isset($full_refund))
	  {
		...
		{
	  	?>
	  	<div class="span4 col-md-4 col-sm-4 col-xs-12 cacel_pad">
