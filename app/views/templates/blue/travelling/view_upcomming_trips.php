...
<?php }
       ...
       <p>
       <input placeholder="Where are you going?" onclick="clear_location(this);" type="text" class="location rounded_left seachinginput col-md-4 col-sm-6 col-xs-12" autocomplete="off" id="location" name="location" />
