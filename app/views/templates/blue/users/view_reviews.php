...
<div id="dashboard_container" class="view_Reviews_Common col-sm-9 col-md-9 col-xs-12">
    ...
    <div class="Box_Content">
      ...
      <div style="width:100%;" class="quotes" id="user_result_review">
      	<ul>
            ...
            <div class="col-md-2 col-sm-3 col-xs-4 fullwidth370" style="width:110px;">
            ...
            <div class="col-md-10 col-sm-9 col-xs-8 fullwidth370" style="width:140px">
