...
.editphone3{margin:0px !important;}
@media (max-width:400px){.Box_Head .Box_Head_Right{float:left;}}
...
@media only screen and (max-width:640px){
	#save_changes span,.btn_dash.can-dash span{
		font-size: 13px;
	}
	.save_cancel{
		padding: 0 !important;
...
<script>
	...
	$(document).ready(function() {
		$("#user_profile_info_about").keyup(function() {
		    var cs = $(this).val().length;
		    if(cs < 50){
		    	 var tem = 50 - cs;
		    	 $('#characters').show();
		    	 $('#characters').text(tem+ " CHARACTERS LEFT");
		    }else{
		    	$('#characters').hide();
		    }
		...
		$("#user_profile_info_about").bind("cut copy paste", function() {
		    var cs = $(this).val().length;
		    if(cs < 50){
		    	 var tem = 50 - cs;
		    	 $('#characters').show();
...
<script>
$(document).ready(function(){
	jQuery("#phone_number").keydown(function(e) {
     ...
     jQuery("#phone_number_verification2").keydown(function(e) {
        if (e.shiftKey || e.ctrlKey || e.altKey) {
            e.preventDefault()
        } else {
            var t = e.keyCode;
      ...
      jQuery("#phone_number_verification").keydown(function(e) {
        if (e.shiftKey || e.ctrlKey || e.altKey) {
            e.preventDefault()
        } else {
            var t = e.keyCode;
...
<div id="dashboard_container" class="col-md-9 col-sm-9 col-xs-12">
     ...
     <h2 class="prfl_head"><?php echo translate("About You"); ?> 
         <span class="Box_Head_Right" id="show_date_time"></span>
        	...
        	<div class="Box_Content clearfix" style="padding: 0px;">
             <div id="Edit_Pro_Left" class="clsFloatLeft col-md-3 col-sm-3 col-xs-12 ">
		  ...
		  // }
			    ?>"  /> 
							...
							<form action="<?php echo site_url('users/photo/'.$user_id); ?>" name="user_photo" id="user_photo" method="post" enctype="multipart/form-data">                 		
									...
									<p class="col-md-12 col-sm-12 col-xs-12"><button type="submit" id="upload_image_submit_button" class="btn_dash"  name="commit"><span><span><?php echo translate("Upload photo"); ?></span></span></button></p>
       </form>

        	</div> 
            </div>
												
             <div id="Edit_Pro_Right" class="col-md-9 col-sm-9 col-xs-12 padding-zero">
               <form action="<?php echo site_url('users/edit/'.$user_id); ?>" method="post" name="user_edit" id="user_edit" style="overflow:hidden;">              	
                            <ul class="pro-list" style="overflow:hidden;">
                            	<li style="font-size: 14px;background:#efefef;padding-top:10px;">                                     	
                                     		<h2 style="text-align: left;"><?php echo translate("Required"); ?></h2>                                	
                                     </li>
                                    <li class="col-md-12 col-sm-12 col-xs-12 padding-zero">
                                        <p class=" label-edit col-md-3 col-sm-5 col-xs-12"><?php echo translate("First Name"); ?><span class="col_span">:</span></p>
                                        <span class="col-md-9 col-sm-6 col-xs-12 users_pro">
                                        <input class="name_input" maxlength="15" style="margin:0 10px 0 0;" id="user_first_name" name="Fname" size="30" type="text" value="<?php if(isset($profile->Fname)) echo $profile->Fname; else echo '""'; ?>" /></span>
										<span class="fname">
										<?php echo form_error('Fname'); ?>
                                        </span>		
                                    </li>
									<li class="col-md-12 col-sm-12 col-xs-12 padding-zero">
									<p class=" label-edit col-md-3 col-sm-5 col-xs-12"><?php echo translate("Last Name"); ?><span class="col_span">:</span></p>
                                        <span class="col-md-9 col-sm-6 col-xs-12 users_pro"><input class="name_input" id="user_last_name" maxlength="15" name="Lname" size="30" type="text" value="<?php if(isset($profile->Lname)) echo $profile->Lname; else echo '""'; ?>" /></span>
									<span class="fname">
										<?php echo form_error('Lname'); ?>
                                        </span>	
									</li>
									<li class="col-md-12 col-sm-12 col-xs-12 padding-zero">
									<p class=" label-edit col-md-3 col-sm-5 col-xs-12"><?php echo translate("I am"); ?><i class="fa fa-lock" style="margin:0px 3px;font-size:14px !important;color:#eb3c44;" title="Private"></i>	<span class="col_span">:</span></p>
                                       ...
                                       <span class="col-md-9 col-sm-6 col-xs-12 users_pro">
                                        	<select name="gender" id="gender">
												...
												{
													?>
													<option value="Gender" id="genderval">Gender</option>
												<?php } ?>
                                        		<option value="male" id="genderval" <?php if($profile->gender == 'male') echo 'selected'; ?>>Male</option>
                                        		<option value="female" id="genderval" <?php if($profile->gender == 'female') echo 'selected'; ?>>Female</option>
                                        		<option value="other" id="genderval" <?php if($profile->gender == 'other') echo 'selected'; ?>>Other</option>
                                        	</select>
                                        	<span class="err-msg" style="color: #ffffff;"></span>
                                        </span>
									</li>
									<li class="col-md-12 col-sm-12 col-xs-12 padding-zero">
									<p class=" label-edit col-md-3 col-sm-5 col-xs-12"><?php echo translate("Birth Date"); ?><i class="fa fa-lock" style="margin:0px 3px;font-size:14px !important;color:#eb3c44;" title="Private"></i>	<span class="col_span">:</span></p>
                                        <span class="col-md-9 col-sm-6 col-xs-12 users_pro"><input type="text" id="dob" name="dob" size="8" value="<?php echo $profile->dob; ?>" placeholder="mm/dd/yyyy" readonly/></span>
									</li>
                                    <li class="col-md-12 col-sm-12 col-xs-12 padding-zero">
                                        <p class=" label-edit col-md-3 col-sm-5 col-xs-12">
                                      ...
                                      <span><?php echo 	$this->session->flashdata('msgs','is pending for verification.');?></span>

										<p><?php echo form_error('email'); ?></p>
                                        </span>
                                    </li>
                                       <li class="col-md-12 col-sm-12 col-xs-12 padding-zero">
                                        <p class="label-edit col-md-3 col-sm-5 col-xs-12" valign="top"><?php echo translate("Phone Number"); ?>                                        <i class="fa fa-lock" style="font-size:14px !important;color:#eb3c44;" title="Private"></i><span class="col_span">:</span></p>
	
                                       <span class="col-md-9 col-sm-6 col-xs-12 users_pro">
                                       
                                        	<div id="pre_add_phone_no" class="clearfix">
                    						<?php echo translate('No phone number entered'); ?>
                    					    <a id="add_phone_no"><?php echo translate('Add a Phone number');?></a></div>
                                            <?php
                                           //	if($profile->phnum != '')
										//	{
												?>
												<div id="verified" class="editverify" style="width:100%;">
  ...
  <div class="pniw-number-container clearfix editphone1">
    ...
    <input name="phonenumber" type="text" id="phone_number" class="pniw-number editphone2" maxlength="15">
  </div>
  ...
  <input type="hidden" value="10346170" name="user_id">
    ...
    <div class="pnaw-verify-container">
      <a id="verify_sms" rel="sms" href="javascript:void(0);" class="btn_dash" style="float:left;">Verify via SMS</a>
      <!--<a rel="call" href="javascript:void(0);" class="btn btn-primary">Verify via Call</a>-->
      <a href="javascript:void(0);" rel="cancel" class="cancel" style="display: none;float:left;padding:5px 5px;">Cancel</a>
      <a style="float:left;padding:5px 5px;" target="_blank" href="<?php echo base_url();?>home/help/17" class="why-verify">Why Verify?</a>
    </div>
  </div>
  <div class="pnaw-step2 editphone3" style="display:none;">
    ...
    <div class="pnaw-verify-container">
      ...
      <a href="javascript:void(0);" rel="cancel" class="btn_dash cancel">
        Cancel
      </a>
    </div>
    ...
    <p class="cancel-message">If it doesn't arrive, click cancel and try again.</p>
                                    ...
                                    <li class="col-md-12 col-sm-12 col-xs-12 padding-zero">
                                        <p class=" label-edit col-md-3 col-sm-5 col-xs-12"><?php echo translate("Where You Live"); ?><span class="col_span">:</span></p>
                                        <span class="col-md-9 col-sm-6 col-xs-12 users_pro"><input id="user_profile_info_current_city" name="live" value="<?php if(isset($profile->live)) echo $profile->live; else echo ''; ?>" size="30" type="text" /><br />
                                        	<span style="color:#9c9c9c; text-style:italic; font-size:11px;"><?php echo translate("Ex_live"); ?></span><br /></span>
                                    </li>
                                     <li class="col-md-12 col-sm-12 col-xs-12 padding-zero" style="margin-bottom: 25px;">
                                        <p class="label-edit col-md-3 col-sm-5 col-xs-12" style="vertical-align:top;"><?php echo translate("Describe Yourself"); ?><span class="col_span">:</span></p>
                                        <span class="col-md-9 col-sm-6 col-xs-12 users_pro" ><textarea cols="40" id="user_profile_info_about" name="desc" rows="20" style="width:100%;height:200px; max-width: 600px;">
<?php if(isset($profile->describe)) echo strip_tags(str_replace('[removed]', '', $profile->describe)); ?></textarea>
<span id="characters" class="error"></span></span>
                                     </li>  
                                     <div class="clearfix"></div>
                                     <li style="font-size: 14px;background:#efefef;padding-top: 10px;">                                     	
                                     		<h2 style="text-align: left;"><?php echo translate("Optional"); ?></h2>                                	
                                     </li>
                                         <li class="col-md-12 col-sm-12 col-xs-12 padding-zero">
                                        <p class=" label-edit col-md-3 col-sm-5 col-xs-12"><?php echo translate("School"); ?><span class="col_span">:</span></p>
                                        <span class="col-md-9 col-sm-6 col-xs-12 users_pro"><input id="user_profile_info_employer" name="school" size="30" type="text" value="<?php if(isset($profile->school)) echo $profile->school; else echo '""'; ?>" /></span>
                                    </li>                                                                      
                                    <li class="col-md-12 col-sm-12 col-xs-12 padding-zero">
                                        <p class=" label-edit col-md-3 col-sm-5 col-xs-12"><?php echo translate("Work"); ?><span class="col_span">:</span></p>
                                        <span class="col-md-9 col-sm-6 col-xs-12 users_pro">
                                    ...
                                    <li class="col-md-12 col-sm-12 col-xs-12 padding-zero" id="veri">
                                    <div id="verified" class="col-md-4 col-sm-5 col-xs-12" style="display: none;font-size: 14px;padding:0px 0px 10px;">
 ...
 <div class="pnaw-step2_new col-md-3 col-sm-5 col-xs-12" style="display: none;">
 </div>
  <!--<div class="pnaw-step2 col-md-5 col-sm-6 col-xs-12" style="display:none;">
    ...
    <div class="pnaw-verify-container">
     ...
     <span class="can_sp"> <a href="javascript:void(0);" rel="cancel" class="cancel">
        Cancel
      </a></span>
    </div>
    <p class="cancel-message">If it doesn't arrive, click cancel and try again.</p>
                                    ...
                                    <li class="col-md-12 col-sm-12 col-xs-12 padding-zero">
                                        <p class="label-edit col-md-3 col-sm-5 col-xs-12 " valign="top"><?php echo translate("Time Zone"); ?><span class="col_span">:</span></p>
                                        <span class="col-md-9 col-sm-6 col-xs-12 time_new users_pro"> <?php echo timezone_menu(get_user_timezone($this->dx_auth->get_user_id())); ?>  </span>
                                    </li>
																																																																								
                     <li class="col-md-12 col-sm-12 col-xs-12 padding-zero">
                                        <p class="label-edit col-md-3 col-sm-5 col-xs-12 " valign="top"><?php echo translate("Languages"); ?><span class="col_span">:</span></p>
                                         <span class="col-md-9 col-sm-6 col-xs-12 time_new"> 
                                        	<div class="none text-muted row-space-1"><?php echo translate("None"); ?></div>
                                        	<?php
                                        	if($user_language != '')
											{
                                        	...
                                        	?>
                                        	<a href="javascript:void(0);" class="multiselect-add-more" style="margin-top: 10px;" id="add_language">
     										 <i class="fa fa-plus" style="font-size:14px !important;"></i>
      											Add More
    										</a>
    										<div class="text-muted row-space-top-1"><?php echo translate("Add languages you speak."); ?></div> 
                                         </span>
                                </li>
<!--
                                             <li class="col-md-12 col-sm-12 col-xs-12 padding-zero">
                                        <p class="label-edit col-md-3 col-sm-5 col-xs-12 " valign="top"><?php echo translate("Emergency contact"); ?>
                                        <i class="fa fa-lock" style="font-size:14px !important;color:#eb3c44;" title="Private"></i>
                                        <span class="col_span">:</span></p>
                                         <span class="col-md-5 col-sm-6 col-xs-12">
                                        	<?php
                                      ...
                                      <li class="col-md-12 col-sm-12 col-xs-12 padding-zero">
						              	  <p class="label-edit col-md-3 col-sm-5 col-xs-12 emergency_contact" valign="top">
						              		Name<sup class="sup-list">*</sup><span class="col_span">:</span> </p>
						               <span class="col-md-5 col-sm-6 col-xs-12 emergency_contact">
						         ...
						         <li class="col-md-12 col-sm-12 col-xs-12 padding-zero emergency_contact">
						              	<p class="label-edit col-md-3 col-sm-5 col-xs-12 " valign="top">
...
<li class="col-md-12 col-sm-12 col-xs-12 padding-zero">      
<p class="hide_in_sm label-edit col-md-3 col-sm-5 col-xs-12" style="vertical-align:top;"></p>
   <span class="save_cancel col-md-9 col-sm-12 col-xs-12" style="padding:0px 0px 0px 15px;" >                  
	 <button  type="submit" class="btn_dash save-dash" style="width: auto;" id="save_changes" name="commit">
	 	<span>
	 		<span><?php echo translate("Save Changes"); ?></span>
	 	
	 </span>
	 </button>
                           	<span class="or_span"><?php echo translate('or'); ?> </span>
              	
               <a href="<?php echo base_url().'users/edit'; ?>"  class="btn_dash can-dash" style="width: auto;text-decoration: none;" >
               		 	<span>
...
<!--link href="<?php echo base_url().'Cloud_data/css_red/templates/blue/dashboard.css'; ?>" media="screen" rel="stylesheet" type="text/css" />-->
<style type="text/css">
.help{color:#FF0000;}
.phone-number-verify-widget {
    border: 1px solid #c3c3c3;
...
{	
	 $.ajax({
            url: "echo base_url()?>users/mobile_verification",            
            type: "POST",                       
            data:"phone_number="+$('.pniw-number-prefix').text()+$('#phone_number').val(),
            success: function (result) { 
            	$('.pnaw-verification-error').hide();
...
@media only screen and (min-width:768px) and (max-width:1024px){
	#save_changes span, a.btn_dash.can-dash span{
...
@media only screen and (max-width:640px){
	...
	li .users_pro, li .time_new, span.save_cancel{
		padding-left: 0px;
	}
	li span.save_cancel{
		padding-left: 0px;
