...
<div id="dashboard_container" class="col-md-9 col-sm-9 col-xs-12 padd-zero">   
	...
	<div class="Box" id="View_GetRecom_2">
    	<div class="Box_Head msgbg"><h2><?php echo translate("Email your friends"); ?></h2></div>
         ...
         <p><?php echo translate("Friends you email can sign up on")." ".$this->dx_auth->get_site_title()." ".translate("to write you a personal reference. You can review new references and either accept or ignore them before they are displayed on your public profile."); ?> 
       
		 
		 <div class="padd-zero col-md-6 col-sm-6 col-xs-12" >
