...
<div class="container-fluid top-sp body-color">
 ...
 <h1 class="page-header1"><?php echo translate_admin('Facebook Connect Settings'); ?></h1>
</div>
...
<table class="table tablet1" cellpadding="2" cellspacing="0">
 <tr>
  <td><?php echo translate_admin('FB Application ID'); ?><span style="color: red;">*</span></td>
  <td><input type="text" name="fb_api_id" value="<?php if(isset($fb_api_id)) echo $fb_api_id; ?>"></td>
 </tr>
 <tr>
  <td><?php echo translate_admin('FB Application Secret'); ?><span style="color: red;">*</span></td>
