...
<div id="left" class="col-md-2 col-sm-2 col-xs-12 paddingzero">
  ...
  <li class="accordion-group">
   ...
   <li class="accordion-group">
    ...
    <ul id="site-nav" class="collapse" style="height:0px;">
       ...
       <li class="accordion-group">
        <a href="<?php echo admin_url('Manage_video'); ?>" data-target="#man-sta-nav" data-toggle="collapse" data-parent="#menu"><i class="fa fa-file-video-o fav_icon" aria-hidden="true"></i><?php echo translate_admin('Manage video'); ?></a></li>
        <li class="accordion-group">
	...
	<ul id="member-nav" class="collapse" style="height: 0px;">
      ...
      <li><a href="javascript:void(0);" id="export_user" ><i class="icon-"></i><?php echo translate_admin('Export User Details'); ?></a></li>
        <li><a href="javascript:void(0);" id="export_superhost" ><i class="icon-"></i><?php echo translate_admin('Export Super Host Details'); ?></a></li>
     </ul>
     
     </li>
     	     <li class="accordion-group">
     <a href="javascript:void(0);" data-target="#user-nav" data-toggle="collapse" data-parent="#menu"><i class="fa fa-list fav_icon" aria-hidden="true"></i><?php echo translate_admin('User Listing Management'); ?></a>
     <ul id="user-nav" class="collapse" style="height: 0px;">
     <li><a href="<?php echo admin_url('lists'); ?>"><i class="icon-"></i><?php echo translate_admin('Listing Management'); ?></a></li>
     <li><a href="javascript:void(0);" id="export_list" ><i class="icon-"></i><?php echo translate_admin('Export List Details'); ?></a></li>
     </ul>	
     </li>
     	
     	<li class="accordion-group">
  	<a href="<?php echo admin_url('email/user_notification'); ?>" ><i class="fa fa-bell-o fav_icon" aria-hidden="true"></i><?php echo translate_admin('User Notification'); ?></a></li>
     ...
     <ul id="man-ame-nav" class="collapse" style="height:0px;">
       ...
       <li class="accordion-group <?php if($this->uri->segment(2) == 'room_type') echo "selected"; ?>">
         <a href="javascript:void(0);" data-target="#man-pro-nav1" data-toggle="collapse" data-parent="#menu"><i class="fa fa-cog fav_icon" aria-hidden="true"></i><?php echo translate_admin('Manage Room types'); ?></a>
         <ul id="man-pro-nav1" class="collapse" style="height: 0px;">
		<!--<li><a href="<?php echo admin_url('room_type/view_room'); ?>"><i class="icon-i"></i><?php echo translate_admin('Add Room type'); ?></a></li>-->
		<li><a href="<?php echo admin_url('room_type/view_all_room'); ?>"><i class="icon-i"></i><?php echo translate_admin('View Room types'); ?></a></li>
      </ul>
      </li>  
       ...
       <li><a href="<?php echo admin_url('neighbourhoods/viewknowledge'); ?>"><i class="icon"-></i><?php echo translate_admin('View Local Knowledges'); ?></a></li>
        ...
        <li class="accordion-group">
        <a href="<?php echo admin_url('social/sinch_settings'); ?>" data-target="#google-nav" data-toggle="collapse" data-parent="#menu"><i class="fa fa-cloud-upload fav_icon" aria-hidden="true"></i><?php echo translate_admin('Sinch Connect'); ?></a></li>
        <li class="accordion-group"> 
...
<script>
	$(document).ready(function(){
        ...
        {
        		var data = 'export=1';
				window.location.href="<?php echo base_url();?>administrator/lists/export_lists?"+data;
        })
        $('#export_user').click(function()
        {
        		var data = 'export=1';
				window.location.href="<?php echo base_url();?>administrator/lists/export_user?"+data;
        })
        $('#export_superhost').click(function()
        {
        		var data = 'export=1';
				window.location.href="<?php echo base_url();?>administrator/lists/export_superhost?"+data;
        })
	});
