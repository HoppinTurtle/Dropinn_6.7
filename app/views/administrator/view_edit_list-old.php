  ...
  google.maps.event.addListener(marker1, 'dragend', function(event)
  {
     ...
     lat = marker1.getPosition().lat();
 	 lng = marker1.getPosition().lng();
 	   ...
 	   jQuery.getJSON("http://maps.googleapis.com/maps/api/geocode/json?latlng="+lat+","+lng+"&sensor=true", function( data ) {
        ...
        rules: {
	            nightly: { 
	            	...
	            	//minStrict: 9 
				        ...
				        weekly: { required:true,number: true,
				        	//minStrict: 0 
				        	},
				...
				cleaning: { required:true,number: true,
					//minStrict: 0 
					},
				security: { required:true,number: true,
					//minStrict: 0 
					},
        },
...
<input id="hosting_price_for_extra_person_native" name="extra" size="30" type="text" value=<?php echo $price->addguests; ?> />
 ...
 <tr>
 	<td><?php echo translate_admin("Per night for each guest after"); ?>    </td>    
 	<td>        
...
<div class="col-md-9 col-xs-9 col-sm-9">
<table class="table" cellpadding="2" cellspacing="0">  
        <h3 class="page-header1" style="font-size: 25px !important;">
          <?php echo translate_admin("Enter Address");?></span></p>
          <p><small class="addrs_small"><?php echo translate_admin("What is your listing's address?");?></small></p>
  	<tr>
  		<td>
    <?php echo translate_admin("Country");?>
    </td>
    <td>
  ...
  <tr>
  	<td>
    <?php echo translate_admin("Street Address");?>
    </td>
    <td>
...
<input type="hidden" name="hidden_lng" id="hidden_lng_edit"/>
  <tr>
  	<td>
    <?php echo translate_admin("Apt, Suite, Bldg. (optional)");?>
    </td>
    <td>
...
<tr>
    ...
    <?php echo translate_admin("ZIP Code");?></td><td>
    ...
    <tr>
    	<td></td>
    	<td>
    <input type="submit" id="next-btn1" onclick="disable()" value="<?php echo translate("Next");?>">
    <input type="submit" class="can-but" id="next-btn" style="display: none" value="<?php echo translate("Next");?>">
    </td>
</table>
</form>
</div>
...
<div style="border:none;" class="panel-footer">
   <!-- <button class="cancel-btn" id="cancel_popup3">
	...
	<div class="lys_address">
		...
		{
			?>
			<img id="static_map" src="http://maps.googleapis.com/maps/api/staticmap?center=<?php echo $lat.','.$long; ?>&size=370x277&zoom=15&format=png&markers=color:red|label:|<?php echo $lat.','.$long; ?>&sensor=false&maptype=roadmap&style=feature:water|element:geometry.fill|weight:3.3|hue:0x00aaff|lightness:100|saturation:93|gamma:0.01|color:0x5cb8e4">
			<?php
		}
		else {
			?>
     ...
     <input type="submit" id="add_address" value="<?php echo translate("Add address");?>">
...
<input type="hidden" id="mouse_y">
                ...
                <div>
                  ...
                  <div class="col-md-9 col-xs-9 col-sm-9">
                  <div class="Box_Head1">
                    <h2 class="page-header1">
                    	<span class="edit_room_icon calendar">
                    	</span><?php echo $list_title;?> - Calendar</h2></div></div>
                    <br>
                    <div class="col-md-9 col-xs-9 col-sm-9">
...
jQuery('#add_address').click(function()
 ...
 jQuery('#edit_address1').click(function()
  ...
  jQuery('.disable-btn').click(function()
     ...
     jQuery('#next-bfftn').click(function()
     {
