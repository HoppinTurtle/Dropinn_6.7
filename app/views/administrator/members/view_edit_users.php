...
<div class="img-popup">
<?php	if($view !=''){ ?>
<img src="<?php echo base_url().'verify/'.$view; ?>" style="width:40px !important; height:40px !important;"/>
<div class="img-popup-hover">
<img src="<?php echo base_url().'verify/'.$view; ?>" style="width:100% !important; height:100% !important;"/>	
<?php } ?>
</div>
</td>
<tr>
...
<div class="img-popup">
<?php	if($viewf !=''){ ?>	
<img src="<?php echo base_url().'verify/'.$viewf; ?>" style="width:40px !important; height:40px !important;" />
<div class="img-popup-hover">
<img src="<?php echo base_url().'verify/'.$viewf; ?>" style="width:100% !important; height:100% !important;"/>	
<?php } ?>
</div>
</div>
</td>
...
<tr>
<td></td>
<td><input type="submit" name="commit" style="margin-top: 15px;" value="<?php echo translate_admin("Update"); ?>"></td>
</tr>
</table>
