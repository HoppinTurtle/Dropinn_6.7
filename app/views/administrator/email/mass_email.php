...
<table class="table" id="sort_list" cellpadding="2" cellspacing="0">
...
<tr valign="top">
			<td><?php echo translate_admin('Email To'); ?><span style="color: red;">*</span></td>
			<td> 
			 <input type="radio" name="is_private" id="is_private" onclick="javacript:showhide(this.value);" value="0"> <?php echo translate_admin('All Users'); ?> &nbsp;
...
function showhide(id)
{
	...
	{
//alert()
	jQuery("#is_private1").prop('checked', 'checked');
	...
	jQuery("#is_private").prop('checked', 'checked');
