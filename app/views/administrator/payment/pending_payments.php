...
{
	$(".sort_list").css("border-bottom", "none");
	$('.sort_list').DataTable({
...
<?php  				
		...
		echo validation_errors();
				...
				$tmpl = array (
                    'table_open'          => '<div class="col-xs-12 col-md-12 col-sm-12"><table id="tableData"  class="table1 res_table sort_list" cellpadding="2" cellspacing="0">
',
