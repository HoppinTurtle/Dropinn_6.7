...
<?php 
  echo form_open('administrator/payment/paymode');
			...
			if($msg = $this->session->flashdata('flash_message'))
			{
				...
				$tmpl = array (
                    'table_open'          => '<div class="col-xs-12 col-md-12 col-sm-12"><table class="table1 res_table" cellpadding="2" cellspacing="0">',
		...
		echo '<div class="container-fluid top-sp body-color"><div class=""><div class="col-xs-12 col-md-12 col-sm-12"><h1>&#160;</h1><div class="but-set"><span3>';
