...
e.preventDefault();
	...
	<div class="col-xs-12 col-md-12 col-sm-12">
	 <h1 class="page-header3"><?php echo translate_admin('Change Reservation Request Commission'); ?></h1>
	 <div class="but-set">
  ...
  <table class="table" cellpadding="2" cellspacing="0">			
       ...
       <td class="clsName"><?php echo translate_admin('Promotion Type'); ?></td>
							<td> <input type="radio" <?php if($result->is_fixed == 1) echo 'checked="checked"'; ?> name="is_fixed" onclick="javacript:showhideF(this.value);" value="1"> Fixed Pay
								<p><input type="radio" <?php if($result->is_fixed == 0) echo 'checked="checked"'; ?> name="is_fixed" onclick="javacript:showhideF(this.value);" value="0"> Percentage Pay</p>
				</tr>
       ...
       <td class="clsName"><?php echo translate_admin('Currency'); ?><span class="clsRed">*</span></td>
							<td> 
