...
<?php 
  echo form_open('administrator/payment/manage_gateway');
			...
			if($msg = $this->session->flashdata('flash_message'))
			{
				...
				$tmpl = array (
                    'table_open'          => '<div class="col-xs-12 col-md-12 col-sm-12"><table class="table1" cellpadding="2" cellspacing="0">',
		...
		echo '<div class="container-fluid top-sp body-color"><div class=""><div class="col-xs-12 col-md-12 col-sm-12"><h1>&#160;</h1>';			
