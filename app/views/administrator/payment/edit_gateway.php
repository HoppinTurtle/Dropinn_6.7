  ...
  <?php 
	 ...
	 <table class="table">
       ...
       <td><?php echo translate_admin('Is Active?'); ?><span style="color: red;">*</span></td>
				...
				{ $showPE = 'inline-table'; $showP = 'none'; $show2C = 'none'; }
				?>	
       ...
       <td><?php echo translate_admin('Payment Type'); ?><span style="color: red;">*</span></td>
				...
				<table id="Credit" class="table" style="display:<?php echo $showPE; ?>;">
	  	<tr>
       <td class="clsName"><?php echo translate_admin('Test SecretKey'); ?><span class="clsRed">*</span></td>
							<td>
         <input type="text" size="70" name="SecretKey" value="<?php echo $SecretKey ; ?>">
							
                            </td>
				</tr>
				
					<tr>
       <td class="clsName"><?php echo translate_admin('Test PublishableKey'); ?><span class="clsRed">*</span></td>
							<td>
         <input type="text" size="70" name="PublishableKey" value="<?php echo $PublishableKey ; ?>">
							 
                            </td>
				</tr>
				
					<tr>
       <td class="clsName"><?php echo translate_admin('Live SecretKey'); ?><span class="clsRed">*</span></td>
							<td>
         <input type="text" size="70" name="LSecretKey" value="<?php echo $LSecretKey ; ?>">
							
                            </td>
				</tr>
				
					<tr>
       <td class="clsName"><?php echo translate_admin('Live PublishableKey'); ?><span class="clsRed">*</span></td>
							<td>
         <input type="text" size="70" name="LPublishableKey" value="<?php echo $LPublishableKey ; ?>">
			...
			<!--<tr>
       <td class="clsName"><?php echo translate_admin('Password'); ?><span class="clsRed">*</span></td>
							<td>
         <input type="text" size="70" name="pwd" value="<?php echo $pwd; ?>">
							 
                            </td>
                            
			</tr>	-->
					<tr>
       <td class="clsName"><?php echo translate_admin('URL Mode'); ?><span class="clsRed">*</span></td>
							
							<td>
								<select name="credit_url" id="credit_url" >
									<?php if($stripe_live == 1)
							{?>
								<option value="1" checked > Yes (Live)</option>
								<option value="0"> No (Sandbox) </option>
								
						<?php	} else { ?>
								<option value="0" checked > No (Sandbox) </option>
