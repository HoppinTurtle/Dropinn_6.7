...
/* The following controllers doesn't has their index function */

//$route['users']         = 'info';
// $route['calendar']      = 'info';
// $route['cron']          = 'info';
// $route['database_cron']  = 'info';
// $route['message']        = 'info';
// $route['neighbourhoods'] = 'info';
 $route['pages']       = 'info';
// $route['rss']         = 'info';
// $route['statistics']  = 'info';
// $route['travelling']  = 'info';
// $route['trips']       = 'info';
// $route['info/(:any)'] = 'info';
// Calendar //cron //database_cron //message //neighbourhoods //pages //rss //statistics //travelling //trips

/* The above controllers doesn't has their index function */
...
$route['travelling'] 			= 'info';
$route['trips']       			= 'info';
$route['rooms/([a-zA-Z]+)']     = "info";
$route['users/(:num)']			= "info";
$route['users/edit/([a-zA-Z]+)']= "info";
$route['calendar/(:num)']		= "info";
$route['trips/(:num)'] 			= "info";
$route['travelling/(:num)']		= "info";
$route['search/(:num)']			= "info";
*/
