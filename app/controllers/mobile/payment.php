...
//          
            ...
            $user_travel_cretids = NULL;
                ...
                $buyer_name  = $query4->row()->username;
                $buyer_email = $query4->row()->email;
                  $onesignal_id =$query4->row()->onesignal_id;
                $query1      = $this->db->get_where('list', array('id' => $list_id));
                $q        = $query1->result();
                $row_list = $query1->row();
...
//             
   ...
   //  print_r($query);exit;
       if($query->num_rows() != 0)
       {
           ...
           if ($data1['status'] !=5 && $data1['status'] !=6 && $data1['status'] !=11 && $data1['status'] !=12 &&
           $data1['status'] !=13)
           {
           $data['room_id']   = $row->list_id;
...
function cancellation_policy1()
    {
        ...
        $cancellation_policy = $this->db->where('id',$cancel)->from('cancellation_policy')->get();
